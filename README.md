...
An example implementing all three challenge types is below, it can also be found here: https://github.com/FLDebug10/asmp_dna/blob/master/src/main/resources/data/test/events/test.json.
